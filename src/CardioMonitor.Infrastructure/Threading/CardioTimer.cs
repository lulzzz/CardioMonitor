...
namespace CardioMonitor.Infrastructure.Threading
{
    ...
    public class CardioTimer
    {
        ...
        {
            if (null == timerEvent) { throw new ArgumentNullException("timerEvent"); }
            if (null == workTime) { throw new ArgumentNullException("workTime");}
            if (null == period) { throw new ArgumentNullException("period");}
